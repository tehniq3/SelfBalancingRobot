...
double setpoint= 195; //176; //set the value when the bot is perpendicular to ground using serial monitor. 
float angle1 = -15;
float angle2 = 15;
...
void loop() {
   ...
   if (input>setpoint+angle1 && input<setpoint+angle2){//If the Bot is falling 
    //    if (input>150 && input<200){//If the Bot is falling 
   //     if (input>250 && input<260){//If the Bot is falling  
